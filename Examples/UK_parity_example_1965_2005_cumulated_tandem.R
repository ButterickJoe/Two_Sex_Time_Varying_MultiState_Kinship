...
kin_out_1965_2005 <- 
  kin_multi_stage_TV_2_sex_tandem(U_mat_fem[1:40], ## 40 years time-series of demographic rates (1965-2005) see last input...
                         U_mat_male[1:40],
                         F_mat_fem[1:40],
                         F_mat_male[1:40],
                         T_mat_fem[1:40],
...
kin_out_1965_2005%>%filter(group == "Focal", Sex == "Female", year == 1965)%>%
